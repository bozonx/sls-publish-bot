/**
 * Got from https://github.com/mcpeblocker/telegraf-entity
 */

export class TgEntityMessage {
  private text: string;
   ...
   */
  constructor(text: string, entities: Record<string, any>[]) {
    // validate params
...
function entityTypes(text: string, {url, userId, custom_emoji_id, language}: Record<string, any>) {
