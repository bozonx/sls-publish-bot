export default {
	ru: {
		...
		backToSelectBlog: 'К списку блогов',

		// Menu descriptions
		mainHomeDescr:
			'Приветствую в публикаторе. Нажмите на кнопку Open чтобы открыть приложение',
		// mainHomeNoBlogsDescr:
		// 	'На данный момент у вас нет ни одного блога, добавьте их через web UI, нажав на кнопку Open',
		// mainHomeSelectBlogsDescr: 'Выберете блог',
		homeDescr:
		...
		selectTagsDescr:
			'Выберете тэги\n\nЧтобы добавить новые тэги, напишите один или несколько тэгов через запятую. Тэги будут переведены в snake_case. Символ # не нужен',
		pubPostSetupDescr:
			'Проверьте и настройте публикацию\n\nНапишите имя автора если нужно. Чтобы атора сделать ссылкой то напишите в таком формате: Имя Автора | https://example.com',
		...
		noAwaitPublicationsInDescr:
			'На данный момент нет постов, ожидающих публикации',
		...
		warnAdminsPostDeletedFromChannel: 'Этот пост был удалён из канала',
	},
};
