    ...
    switch (block.type) {
      ...
      case NOTION_BLOCK_TYPES.heading_1:
        result.push({
          ...
          children: [{
            type: 'text',
            value: richTextToPlainText((block as any)?.heading_1?.rich_text)
          }],
        })
      ...
      case NOTION_BLOCK_TYPES.heading_2:
        result.push({
          ...
          children: [{
            type: 'text',
            value: richTextToPlainText((block as any)?.heading_2?.rich_text)
          }],
        })
      ...
      case NOTION_BLOCK_TYPES.heading_3:
        result.push({
          ...
          children: [{
            type: 'text',
            value: richTextToPlainText((block as any)?.heading_3?.rich_text)
          }],
        })
      ...
      case NOTION_BLOCK_TYPES.bulleted_list_item:
        const liItem: Element = {
          type: 'element',
          tagName: 'li',
          children: [
            ...richTextToHastElements((block as any)?.bulleted_list_item?.rich_text),
            ...children,
          ],
        };
      ...
      case NOTION_BLOCK_TYPES.numbered_list_item:
        const liItemNum: Element = {
          type: 'element',
          tagName: 'li',
          children: [
            ...richTextToHastElements((block as any)?.numbered_list_item?.rich_text),
            ...children,
          ],
        };
      ...
      case NOTION_BLOCK_TYPES.quote:
        result.push({
          ...
          tagName: 'blockquote',
          children: [
            ...richTextToHastElements((block as any)?.quote?.rich_text),
            ...children,
          ],
        })
      ...
      case NOTION_BLOCK_TYPES.code:
        result.push({
          type: 'element',
          tagName: 'pre',
          properties: { lang: (block as any)?.code?.language },
          children: [
            {
              type: 'text',
              value: richTextToPlainText((block as any)?.code?.rich_text)
            },
            ...children,
          ],
        });
