...
const dict = {
  ...
  menu: {
    ...
    selectTgTags: 'Введите тэги разделяя пробелом, знак # ставить не обязательно. '
  ...
  message: {
    ...
    noImageNoText: '⚠️ Нет ни картинки ни текста',
    //bigCaption: `⚠️ Подпись картинки превышает ${TELEGRAM_MAX_CAPTION} символа`,
    bigPost: `⚠️ Пост превышает ${TELEGRAM_MAX_POST} символа`,
    post2000oneImg: '⚠️ Формат post2000 поддерживает только 1 картинку не более',
